...
import project4_img from "../assets/project_four.svg";
...
const mywork_data = [
  ...
  },
  {
    ...
    title: "My Portfolio",
    w_img: project3_img,
    description: "This portfolio was built with React to showcase my projects and skills as a front-end developer. It features a clean and responsive design, smooth navigation, and reusable components that make it easy to expand with new projects. By using React (with hooks) and modern JavaScript, I focused on creating an interactive, fast, and user-friendly experience that reflects both my technical skills and design approach.",
